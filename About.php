    ...
    <div class="card card-about">
        <div class="card-body">
            <p class="card-text text-1">
                The project was created by Paul Romeo R. Despuig. I am taking up Bachelor's in Information Technology 
                at the Ateneo de Naga University. You may reach me at <i>pdespuig@gbox.adnu.edu.ph</i> or <i>despuig.paulromeo@gmail.com</i>.
            </p>
            <p class="card-text text-2">
                In this time of pandemic, the project is an attempt to provide the public a crowsourcing platform where 
                they can share their health status and see from a particular point the state of health of their community 
                in the midst of COVID-19. 
            </p>
            <p class="card-text text-3">
                This is not a research study, nor will the data be used for research. I am collecting symptom data using 
                the crowdsourcing approach because I have the skills and the technology to do it, and I think that the 
                information will help our authorities in leading us through this pandemic. 
            </p>
        </div>
    </div>
